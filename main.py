...
# 画像の読み込み
img = Image.open('IMG_5372.jpg').rotate(-90)
st.image(img,caption = 'Haru' , use_column_width = True)

# 画像の読み込み
img = Image.open('IMG_5370.jpg').rotate(-90)
st.image(img,caption = 'Haru' , use_column_width = True)
...
# 選択されたアルファベットを表示
st.write('選択されたアルファベット:', selected_alphabet)
